...
$(document).ready(function () {
   ...
   $("#hideText").click(function() {
      $("#showHideBlock").children("p").fadeOut(400);
   });
   
   $("#showText").click(function() {
      $("#showHideBlock").children("p").fadeIn(2000);
   });
   ...
   $("#AddListItem").click(function() {
      var newList = $('<li>List item ' + count +'</li>');
      newList.click(function () {
         $(this).toggleClass('red');
      });
      $('#labList').append(newList);
      count++;
   })
   ...
   $("#toggleText").click(function() {
      $("#showHideBlock").children("p").fadeToggle(400);
